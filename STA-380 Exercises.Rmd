...
In this section, we are processing the training data to eliminate stop words, removing punctuation, make terms lowercase and more. The end result is a document term matrix with tf-idf weights.
